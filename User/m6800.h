...
//static inline uint8_t cpu_readmem16(uint16_t);
//static inline void cpu_writemem16(uint16_t, uint8_t);
//static inline uint8_t cpu_readop(uint16_t);
//static inline uint8_t cpu_readop_arg(uint16_t);

uint8_t cpu_readmem16(uint16_t);
void cpu_writemem16(uint16_t, uint8_t);
//uint8_t cpu_readop(uint16_t);
//uint8_t cpu_readop_arg(uint16_t);

static inline unsigned char cpu_readop(uint16_t addr) {return cpu_readmem16(addr); };
static inline unsigned char cpu_readop_arg(uint16_t addr) {return cpu_readmem16(addr); };
...
void ENTER_INTERRUPT2(const char *message, UINT16 irq_vector);
